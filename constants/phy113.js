export const quizData = {
    ...
    questions: [
      ...
      { 
      question: '2. Which of the following are the correct S.I unit of the quantities indicated I. N( Force) ii. N/m (Torque) iii. Watt( power) IV. Kg/ms^-2(momentum)  ',
      options: ['I and ii only ', 'I,II and iii only ', ' I,iii and iv only ', 'I and iii only'],
      answer: 'I and iii only'
      },
      { 
      question: '3.  For which of the under listed quantities is the derived unit ML^2T^-2 correct i. Moment of force ii. Work iii. Acceleration.  ',
      ...
      { 
      question: '5. The distance xm travelled by a particle in time t seconds is described by the equation x= 10+2t^2, Find the average speed of the particle between the time interval t=2seconds and t=5seconds',
      ...
      options: [' ii,iii and iv only', ' I and iv only', 'I and ii only', 'ii and iii only '],
      answer: 'I and ii only'
      },
      { 
      ...
      { 
      question: '11. A body starts from rest and moves in a straight path with uniform acceleration of 8m/s^2 for 5seconds. It then decelerates uniformly to rest in the next 10seconds. Calculate the magnitude of its acceleration.   ',
      options: ['80m/s^2 ', '16m/s^2 ', '8m/s^2 ', '4m/s^2'],
      answer: '4m/s^2'
      },
      { 
      question: '12. A body falls from rest to the ground in 0.5 seconds. Calculate the height from which it falls ( g=10m/s^2) ',
      ...
      options: ['20kgms^-1', '10kgms^-1  ', '1.5kgms^-1  ', '1.3kgms^-1  '],
      answer: '20kgms^-1'
      },
      { 
      ...
      { 
      question: '19. A particle is projected vertically upwards with a velocity of 20m/s.What Maximum height does it attain (g=10m/s^2)',
      options: ['2000m ', ' 200m', '20m', '2m '],
      answer: '20m'
      },
      { 
      question: '20. A ball is thrown vertically upwards from the ground with an initial velocity of 50m/s. what is the total time spent by the ball in the air? (g=10m/s^2) ',
