export const quizData = {
    ...
    questions : [
      ...
      { 
      question: '3. If A = { ( x, y ) : y2 = 4} and B = { ( x, y ) : y2 = 16}, find the elements of A n B ',
      ...
      { 
      question: '15. Let the function f:w  R be defined by f : x2 – x – 2, where W = {-1,0,2,5,11} and R, the set of real numbers. Find the range of f ',
      options: ['{-2,0,18,108}', '{-2,18,108} ', ' {-1,0,2,5,11} ', ' {-2,0,18} '],
      answer: '{-2,0,18,108}'
      },
      { 
      question: '16. Find the domain of f(x) = x2 + 6 if the range of f is {6,7,10,15} ',
      options: ['{0,1,2,3}', '{-1,0,1,2}  ', ' {5,6,12} ', '{-1,0,1,2}  '],
      answer: '{0,1,2,3}'
      },
      { 
      question: '17. If f(x-4) = x2 + 2x +3, find f(2) ',
      options: [' 6', '11 ', '27 ', '51'],
      answer: '51'
      },
      { 
      question: ' 18. If f(x+2) = 2x2 + 7x – 5, find f(-1) ',
      options: [' -10', '-8', '4 ', '10 '],
      answer: '-8'
      },
      { 
      question: '19.If f(x) = 2x2 – 5x + 3, find f(x+1) ',
      options: ['2x2 – x', ' 2x2 – x + 10 ', ' 4x3 +3x + 2 ', '4x3 +3x + 3 '],
      answer: '2x2 – x'
      },
      { 
